...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ftthCustomerInfoController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="openId" name="openId" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${ftthCustomerInfoPage.openId}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="phone" name="phone" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${ftthCustomerInfoPage.phone}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${ftthCustomerInfoPage.name}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
									  <input id="createTime" name="createTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })"
						      						 ...
						      						 value='<fmt:formatDate value='${ftthCustomerInfoPage.createTime}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="upperOpenId" name="upperOpenId" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${ftthCustomerInfoPage.upperOpenId}'>
							<span class="Validform_checktip"></span>
