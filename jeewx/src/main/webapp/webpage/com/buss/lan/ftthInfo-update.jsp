...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ftthInfoController.do?doUpdate" tiptype="1">
						...
						<td class="value">
									  <input id="createTime" name="createTime" type="text" style="width: 150px" 
						      						class="Wdate" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })"
						      						 ...
						      						 value='<fmt:formatDate value='${ftthInfoPage.createTime}' type="date" pattern="yyyy-MM-dd HH:mm:ss"/>'>    
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="sellerOpenId" name="sellerOpenId" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${ftthInfoPage.sellerOpenId}'>
							<span class="Validform_checktip"></span>
