...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="ftthCommissionInfoController.do?doUpdate">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="openId" name="openId" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${ftthCommissionInfoPage.openId}'>
			...
			<td class="value">
		     	 <input id="amount" name="amount" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${ftthCommissionInfoPage.amount}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="dealAmount" name="dealAmount" type="text" style="width: 150px" class="inputxt"  
					                ...
					                value='${ftthCommissionInfoPage.dealAmount}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="createTime" name="createTime" type="text" style="width: 150px" 
					                ...
					                value='<fmt:formatDate value='${ftthCommissionInfoPage.createTime}' type="date" pattern="yyyy-MM-dd"/>'>   
				<span class="Validform_checktip"></span>
